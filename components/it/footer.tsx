export function Footer() {
  const quickLinks = [
    { label: "Avviso Legale", href: "https://www.beversia.com/policies/legal-notice" },
    { label: "Informazioni di Contatto", href: "https://www.beversia.com/policies/contact-information" },
    { label: "Informativa sulla Privacy", href: "https://www.beversia.com/policies/privacy-policy" },
    { label: "Politica di Rimborso", href: "https://www.beversia.com/policies/refund-policy" },
    { label: "Politica di Spedizione", href: "https://www.beversia.com/policies/shipping-policy" },
    { label: "Termini di Servizio", href: "https://www.beversia.com/policies/terms-of-service" },
  ]
  ...
  return (
    <footer className="bg-primary text-white">
      <div className="container mx-auto px-4 py-12">
        {/* Quick Links Section */}
        <div className="mb-8">
          <h3 className="text-xl font-bold mb-6 text-center md:text-center">Link Rapidi</h3>
